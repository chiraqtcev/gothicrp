...
function _languageConnect(id) -- в OnPlayerConnect к остальным _nameConnect(playerid)
	...
	Player[id]._language_pizdabol = 0;
				...
				if GetDistancePlayers(id, i) < 600 then
					if Player[i]._language_waran ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 255, 255, 255, Player[id].zvanie.." "..pName..": "..text.." (Язык ящеров)");
						else
							SendPlayerMessage(i, 255, 255, 255, pName..": "..text.." (Язык ящеров)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 255, 255, 255, pName..": ".._languageCode(id).." (Язык ящеров)");
					end

				elseif GetDistancePlayers(id, i) >= 600 and GetDistancePlayers(id, i) < 800 then
					if Player[i]._language_waran ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 170, 170, 170, Player[id].zvanie.." "..pName..": "..text.." (Язык ящеров)");
						else
							SendPlayerMessage(i, 170, 170, 170, pName..": "..text.." (Язык ящеров)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 170, 170, 170, pName..": ".._languageCode(id).." (Язык ящеров)");
					end

				elseif GetDistancePlayers(id, i) >= 800 and GetDistancePlayers(id, i) <= 1000 then
					if Player[i]._language_waran ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 110, 110, 110, Player[id].zvanie.." "..pName..": "..text.." (Язык ящеров)");
						else
							SendPlayerMessage(i, 110, 110, 110, pName..": "..text.." (Язык ящеров)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 110, 110, 110, pName..": ".._languageCode(id).." (Язык ящеров)");
					end
			...
			for i = 0, GetMaxPlayers() do
				if GetDistancePlayers(id, i) < 600 then
					if Player[i]._language_yarkendar ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 255, 255, 255, Player[id].zvanie.." "..pName..": "..text.." (Зодчий)");
						else
							SendPlayerMessage(i, 255, 255, 255, pName..": "..text.." (Зодчий)");
						end

					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 255, 255, 255, pName..": ".._languageCode(id).." (Зодчий)");
					end

				elseif GetDistancePlayers(id, i) >= 600 and GetDistancePlayers(id, i) < 800 then
					if Player[i]._language_yarkendar ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 170, 170, 170, Player[id].zvanie.." "..pName..": "..text.." (Зодчий)");
						else
							SendPlayerMessage(i, 170, 170, 170, pName..": "..text.." (Зодчий)");
						end

					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 170, 170, 170, pName..": ".._languageCode(id).." (Зодчий)");
					end

				elseif GetDistancePlayers(id, i) > 800 and GetDistancePlayers(id, i) <= 1000 then
					if Player[i]._language_yarkendar ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 110, 110, 110, Player[id].zvanie.." "..pName..": "..text.." (Зодчий)");
						else
							SendPlayerMessage(i, 110, 110, 110, pName..": "..text.." (Зодчий)");
						end

					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 110, 110, 110, pName..": ".._languageCode(id).." (Зодчий)");
					end
			...
			for i = 0, GetMaxPlayers() do
				if GetDistancePlayers(id, i) < 600 then
					if Player[i]._language_demon ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 255, 255, 255, Player[id].zvanie.." "..pName..": "..text.." (Язык демонов)");
						else
							SendPlayerMessage(i, 255, 255, 255, pName..": "..text.." (Язык демонов)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 255, 255, 255, pName..": ".._languageCode(id).." (Язык демонов)");
					end

				elseif GetDistancePlayers(id, i) >= 600 and GetDistancePlayers(id, i) < 800 then
					if Player[i]._language_demon ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 170, 170, 170, Player[id].zvanie.." "..pName..": "..text.." (Язык демонов)");
						else
							SendPlayerMessage(i, 170, 170, 170, pName..": "..text.." (Язык демонов)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 170, 170, 170, pName..": ".._languageCode(id).." (Язык демонов)");
					end
			...
			for i = 0, GetMaxPlayers() do
				if GetDistancePlayers(id, i) < 600 then
					if Player[i]._language_temoris ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 255, 255, 255, Player[id].zvanie.." "..pName..": "..text.." (наречие Тимориса)");
						else
							SendPlayerMessage(i, 255, 255, 255, pName..": "..text.." (наречие Тимориса)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 255, 255, 255, pName..": ".._languageCode(id).." (наречие Тимориса)");
					end

				elseif GetDistancePlayers(id, i) >= 600 and GetDistancePlayers(id, i) < 800 then
					if Player[i]._language_temoris ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 170, 170, 170, Player[id].zvanie.." "..pName..": "..text.." (наречие Тимориса)");
						else
							SendPlayerMessage(i, 170, 170, 170, pName..": "..text.." (наречие Тимориса)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 170, 170, 170, pName..": ".._languageCode(id).." (наречие Тимориса)");
					end

				elseif GetDistancePlayers(id, i) > 800 and GetDistancePlayers(id, i) <= 1000 then
					if Player[i]._language_temoris ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 110, 110, 110, Player[id].zvanie.." "..pName..": "..text.." (наречие Тимориса)");
						else
							SendPlayerMessage(i, 110, 110, 110, pName..": "..text.." (наречие Тимориса)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 110, 110, 110, pName..": ".._languageCode(id).." (наречие Тимориса)");
					end
			...
			for i = 0, GetMaxPlayers() do
				if GetDistancePlayers(id, i) < 600 then
					if Player[i]._language_gatia ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 255, 255, 255, Player[id].zvanie.." "..pName..": "..text.." (Гатийский)");
						else
							SendPlayerMessage(i, 255, 255, 255, pName..": "..text.." (Гатийский)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 255, 255, 255, pName..": ".._languageCode(id).." (Гатийский)");
					end

				elseif GetDistancePlayers(id, i) >= 600 and GetDistancePlayers(id, i) < 800 then
					if Player[i]._language_gatia ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 170, 170, 170, Player[id].zvanie.." "..pName..": "..text.." (Гатийский)");
						else
							SendPlayerMessage(i, 170, 170, 170, pName..": "..text.." (Гатийский)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 170, 170, 170, pName..": ".._languageCode(id).." (Гатийский)");
					end

				elseif GetDistancePlayers(id, i) > 800 and GetDistancePlayers(id, i) <= 1000 then
					if Player[i]._language_gatia ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 110, 110, 110, Player[id].zvanie.." "..pName..": "..text.." (Гатийский)");
						else
							SendPlayerMessage(i, 110, 110, 110, pName..": "..text.." (Гатийский)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 110, 110, 110, pName..": ".._languageCode(id).." (Гатийский)");
					end
			...
			for i = 0, GetMaxPlayers() do
				if GetDistancePlayers(id, i) < 600 then
					if Player[i]._language_afro ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 255, 255, 255, Player[id].zvanie.." "..pName..": "..text.." (Южный)");
						else
							SendPlayerMessage(i, 255, 255, 255, pName..": "..text.." (Южный)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 255, 255, 255, pName..": ".._languageCode(id).." (Южный)");
					end

				elseif GetDistancePlayers(id, i) >= 600 and GetDistancePlayers(id, i) < 800 then
					if Player[i]._language_afro ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 170, 170, 170, Player[id].zvanie.." "..pName..": "..text.." (Южный)");
						else
							SendPlayerMessage(i, 170, 170, 170, pName..": "..text.." (Южный)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 170, 170, 170, pName..": ".._languageCode(id).." (Южный)");
					end

				elseif GetDistancePlayers(id, i) > 800 and GetDistancePlayers(id, i) <= 1000 then
					if Player[i]._language_afro ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 110, 110, 110, Player[id].zvanie.." "..pName..": "..text.." (Южный)");
						else
							SendPlayerMessage(i, 110, 110, 110, pName..": "..text.." (Южный)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 110, 110, 110, pName..": ".._languageCode(id).." (Южный)");
					end
			...
			for i = 0, GetMaxPlayers() do
				if GetDistancePlayers(id, i) < 600 then
					if Player[i]._language_myrtana ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 255, 255, 255, Player[id].zvanie.." "..pName..": "..text);
						else
							SendPlayerMessage(i, 255, 255, 255, pName..": "..text);
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 255, 255, 255, pName..": ".._languageCode(id).." (Миртанский)");
					end

				elseif GetDistancePlayers(id, i) >= 600 and GetDistancePlayers(id, i) < 800 then
					if Player[i]._language_myrtana ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 170, 170, 170, Player[id].zvanie.." "..pName..": "..text);
						else
							SendPlayerMessage(i, 170, 170, 170, pName..": "..text);
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 170, 170, 170, pName..": ".._languageCode(id).." (Миртанский)");
					end

				elseif GetDistancePlayers(id, i) > 800 and GetDistancePlayers(id, i) <= 1000 then
					if Player[i]._language_myrtana ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 110, 110, 110, Player[id].zvanie.." "..pName..": "..text);
						else
							SendPlayerMessage(i, 110, 110, 110, pName..": "..text);
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 110, 110, 110, pName..": ".._languageCode(id).." (Миртанский)");
					end
			...
			for i = 0, GetMaxPlayers() do
				if GetDistancePlayers(id, i) < 600 then
					if Player[i]._language_orcs ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 255, 255, 255, Player[id].zvanie.." "..pName..": "..text.. " (Язык орков)");
						else
							SendPlayerMessage(i, 255, 255, 255, pName..": "..text.." (Язык орков)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 255, 255, 255, pName..": ".._languageCode(id).." (Язык орков)");
					end

				elseif GetDistancePlayers(id, i) >= 600 and GetDistancePlayers(id, i) < 800 then
					if Player[i]._language_orcs ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 170, 170, 170, Player[id].zvanie.." "..pName..": "..text.. " (Язык орков)");
						else
							SendPlayerMessage(i, 170, 170, 170, pName..": "..text.." (Язык орков)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 170, 170, 170, pName..": ".._languageCode(id).." (Язык орков)");
					end

				elseif GetDistancePlayers(id, i) > 800 and GetDistancePlayers(id, i) <= 1000 then
					if Player[i]._language_orcs ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 110, 110, 110, Player[id].zvanie.." "..pName..": "..text.. " (Язык орков)");
						else
							SendPlayerMessage(i, 110, 110, 110, pName..": "..text.." (Язык орков)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 110, 110, 110, pName..": ".._languageCode(id).." (Язык орков)");
					end
			...
			for i = 0, GetMaxPlayers() do
				if GetDistancePlayers(id, i) < 600 then
					if Player[i]._language_warant ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 255, 255, 255, Player[id].zvanie.." "..pName..": "..text.. " (Варантский)");
						else
							SendPlayerMessage(i, 255, 255, 255, pName..": "..text.." (Варантский)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 255, 255, 255, pName..": ".._languageCode(id).." (Варантский)");
					end

				elseif GetDistancePlayers(id, i) >= 600 and GetDistancePlayers(id, i) < 800 then
					if Player[i]._language_warant ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 170, 170, 170, Player[id].zvanie.." "..pName..": "..text.. " (Варантский)");
						else
							SendPlayerMessage(i, 170, 170, 170, pName..": "..text.." (Варантский)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 170, 170, 170, pName..": ".._languageCode(id).." (Варантский)");
					end

				elseif GetDistancePlayers(id, i) > 800 and GetDistancePlayers(id, i) <= 1000 then
					if Player[i]._language_warant ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 110, 110, 110, Player[id].zvanie.." "..pName..": "..text.. " (Варантский)");
						else
							SendPlayerMessage(i, 110, 110, 110, pName..": "..text.." (Варантский)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 110, 110, 110, pName..": ".._languageCode(id).." (Варантский)");
					end
			...
			for i = 0, GetMaxPlayers() do
				if GetDistancePlayers(id, i) < 600 then
					if Player[i]._language_nord ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 255, 255, 255, Player[id].zvanie.." "..pName..": "..text.. " (Нордмарский)");
						else
							SendPlayerMessage(i, 255, 255, 255, pName..": "..text.." (Нордмарский)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 255, 255, 255, pName..": ".._languageCode(id).." (Нордмарский)");
					end

				elseif GetDistancePlayers(id, i) >= 600 and GetDistancePlayers(id, i) < 800 then
					if Player[i]._language_nord ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 170, 170, 170, Player[id].zvanie.." "..pName..": "..text.. " (Нордмарский)");
						else
							SendPlayerMessage(i, 170, 170, 170, pName..": "..text.." (Нордмарский)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 170, 170, 170, pName..": ".._languageCode(id).." (Нордмарский)");
					end

				elseif GetDistancePlayers(id, i) > 800 and GetDistancePlayers(id, i) <= 1000 then
					if Player[i]._language_nord ~= 0 then
						if Player[id].zvanie ~= nil then
							SendPlayerMessage(i, 110, 110, 110, Player[id].zvanie.." "..pName..": "..text.. " (Нордмарский)");
						else
							SendPlayerMessage(i, 110, 110, 110, pName..": "..text.." (Нордмарский)");
						end
					else
						Player[id]._language_text = text;
						SendPlayerMessage(i, 110, 110, 110, pName..": ".._languageCode(id).." (Нордмарский)");
					end
