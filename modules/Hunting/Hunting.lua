...
HUNTENER_LURKER = 50;
HUNTENER_FIREWARAN = 100;

-- drops
SCAVENGER_DROPLIST_NOSKILL = {"uhaxlk_itfo_rawmeat"}
SCAVENGER_DROPLIST_1 = {"uhaxlk_itfo_rawmeat", "ZDPWLA_ITFO_EGG"}
SCAVENGER_DROPLIST_2 = {"uhaxlk_itfo_rawmeat", "ZDPWLA_ITFO_EGG"}
SCAVENGER_DROPLIST_3 = {"uhaxlk_itfo_rawmeat", "ZDPWLA_ITFO_EGG"}

WOLF_DROPLIST_NOSKILL = {"uhaxlk_itfo_rawmeat"}
WOLF_DROPLIST_1 = {"uhaxlk_itfo_rawmeat", "aixopt_itmi_badfur"}
WOLF_DROPLIST_2 = {"uhaxlk_itfo_rawmeat", "aixopt_itmi_badfur"}
WOLF_DROPLIST_3 = {"uhaxlk_itfo_rawmeat", "aixopt_itmi_badfur"}

WARG_DROPLIST_NOSKILL = {"uhaxlk_itfo_rawmeat"}
WARG_DROPLIST_1 = {"uhaxlk_itfo_rawmeat"}
WARG_DROPLIST_2 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_WARGFUR"}
WARG_DROPLIST_3 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_WARGFUR"}

MOLERAT_DROPLIST_NOSKILL = {"uhaxlk_itfo_rawmeat"}
MOLERAT_DROPLIST_1 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_FAT"}
MOLERAT_DROPLIST_2 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_FAT"}
MOLERAT_DROPLIST_3 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_FAT"}
...
KEILER_DROPLIST_NOSKILL = {"uhaxlk_itfo_rawmeat"}
KEILER_DROPLIST_1 = {"uhaxlk_itfo_rawmeat", "aixopt_itmi_badfur"}
KEILER_DROPLIST_2 = {"uhaxlk_itfo_rawmeat", "aixopt_itmi_badfur"}
KEILER_DROPLIST_3 = {"uhaxlk_itfo_rawmeat", "aixopt_itmi_badfur"}

SNAPPER_DROPLIST_NOSKILL = {"uhaxlk_itfo_rawmeat"}
SNAPPER_DROPLIST_1 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_LURKERSKIN"}
SNAPPER_DROPLIST_2 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_LURKERSKIN"}
SNAPPER_DROPLIST_3 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_LURKERSKIN"}

SHADOWBEAST_DROPLIST_NOSKILL = {"uhaxlk_itfo_rawmeat"}
SHADOWBEAST_DROPLIST_1 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_SHADOWFUR"}
SHADOWBEAST_DROPLIST_2 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_SHADOWFUR"}
SHADOWBEAST_DROPLIST_3 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_SHADOWFUR"}

TROLL_DROPLIST_NOSKILL = {"uhaxlk_itfo_rawmeat"}
TROLL_DROPLIST_1 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_TROLLFUR"}
TROLL_DROPLIST_2 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_TROLLFUR"}
TROLL_DROPLIST_3 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_TROLLFUR"}

WARAN_DROPLIST_NOSKILL = {"uhaxlk_itfo_rawmeat"}
WARAN_DROPLIST_1 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_LURKERSKIN"}
WARAN_DROPLIST_2 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_LURKERSKIN"}
WARAN_DROPLIST_3 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_LURKERSKIN"}

GIANT_RAT_DROPLIST_NOSKILL = {"uhaxlk_itfo_rawmeat"}
GIANT_RAT_DROPLIST_1 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_LURKERSKIN"}
GIANT_RAT_DROPLIST_2 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_LURKERSKIN"}
GIANT_RAT_DROPLIST_3 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_LURKERSKIN"}
...
LURKER_DROPLIST_NOSKILL = {"uhaxlk_itfo_rawmeat"}
LURKER_DROPLIST_1 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_LURKERSKIN"}
LURKER_DROPLIST_2 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_LURKERSKIN"}
LURKER_DROPLIST_3 = {"uhaxlk_itfo_rawmeat", "OOLTYB_ITAT_LURKERSKIN"}

FIREWARAN_DROPLIST_NOSKILL = {"OOLTYB_ITAT_WARANFIRETONGUE"}
FIREWARAN_DROPLIST_1 = {"OOLTYB_ITAT_WARANFIRETONGUE"}
FIREWARAN_DROPLIST_2 = {"OOLTYB_ITAT_WARANFIRETONGUE"}
FIREWARAN_DROPLIST_3 = {"OOLTYB_ITAT_WARANFIRETONGUE"}
...
-- params for visual, Y
HUNT_WOLF_PARAMS = {"HUNT_BODY_1.3DS", 80} -- MYASO.3DS
HUNT_WARG_PARAMS = {"HUNT_BODY_2.3DS", 80}
HUNT_SHADOWBEAST_PARAMS = {"HUNT_BODY_3.3DS", 80}
HUNT_TROLL_PARAMS = {"HUNT_BODY_4.3DS", 80}
HUNT_BEAR_PARAMS = {"HUNT_BODY_5.3DS", 80}
HUNT_KEILER_PARAMS = {"HUNT_BODY_6.3DS", 80}
HUNT_FIREWARAN_PARAMS = {"blyat_syka.3DS", 80}

-- delete bodies var
HUNT_REMOVE = false;

-- exps
HUNTING_EXPTOLEVELS = {1000, 1500};

local WORLD = "RPCORNER_KHORINIS.ZEN"
...
function _deathMonster(id, killer)
	...
	if _checkNick(id, killer) == false and Player[killer].hunting == true and IsNPC(id) == 1 then
		...
		elseif _inst(id) == "FIREWARAN" then
			...
			for i = 1, 300 do
				if DROP_POINT[i].status < 1 then
					DROP_POINT[i].status = 1;
					DROP_POINT[i].pos = {x, y, z};
					DROP_POINT[i].fromMob = "FIREWARAN";
					DROP_POINT[i].id = id;
					break
				end
			end
	...
	if Player[id].loggedIn == true and Player[id].hunting == true then
		if down == KEY_G then
			...
			if ONLINE > 0 then
				...
				SendPlayerMessage(id, 255, 255, 255, "Разделывать монстров можно только при онлайне в 5+ человек.")
			end
		end
	end
...
function _skinning(id)
	...
	if Player[id].hcurrent_size_h > Player[id].hzero_size_h then
		...
		elseif DROP_POINT[cell].fromMob == "SNAPPER" then
			...
			elseif DROP_POINT[cell].fromMob == "FIREWARAN" then
			if Player[id].energy >= HUNTENER_FIREWARAN then

				if Player[id].huntlevel == 0 then
					Player[id].energy = Player[id].energy - HUNTENER_FIREWARAN;
					UpdateEnergyBar(id);
					SavePlayer(id);
					local drop = math.random(1,2);
					if drop == 1 then
						LogHunt(id, "FIREWARAN", false, 0);
						GameTextForPlayer(id, 50, 6000, "Вы не смогли освежевать тушу","Font_Old_10_White_Hi.TGA", 255, 0, 0, 3000);
					else
						CreateItem(FIREWARAN_DROPLIST_NOSKILL[1], 0, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						GameTextForPlayer(id, 50, 6000, "Вы не смогли освежевать тушу","Font_Old_10_White_Hi.TGA", 255,0,0, 3000);
						LogHunt(id, "FIREWARAN", true, 0, FIREWARAN_DROPLIST_NOSKILL[1]);
					end
				...
				elseif Player[id].huntlevel == 1 then
					...
					if drop <= 4 then
						...
						DestroyNPC(DROP_POINT[cell].id);
						DROP_POINT[cell].vob = Vob.Create(HUNT_FIREWARAN_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_FIREWARAN_PARAMS[2], DROP_POINT[cell].pos[3]);
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(FIREWARAN_DROPLIST_1[1], 0, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						GameTextForPlayer(id, 50, 6000, "Вы не смогли освежевать тушу","Font_Old_10_White_Hi.TGA", 255,0,0, 3000);
					end
					SavePlayer(id);
					Player[id].huntexp = Player[id].huntexp + HUNTEXP_FIREWARAN;
					UpdateHuntLevel(id);
					SaveHunt(id);
					LogHunt(id, "FIREWARAN", true, HUNTEXP_FIREWARAN, FIREWARAN_DROPLIST_1[1]);
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						DROP_POINT[cell].vob = Vob.Create(HUNT_FIREWARAN_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_FIREWARAN_PARAMS[2], DROP_POINT[cell].pos[3]);
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(FIREWARAN_DROPLIST_2[1], 0, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						GameTextForPlayer(id, 50, 6000, "Вы не смогли освежевать тушу","Font_Old_10_White_Hi.TGA", 255,0,0, 3000);
					end
					SavePlayer(id);
					Player[id].huntexp = Player[id].huntexp + HUNTEXP_FIREWARAN;
					UpdateHuntLevel(id);
					SaveHunt(id);
					LogHunt(id, "FIREWARAN", true, HUNTEXP_FIREWARAN, FIREWARAN_DROPLIST_2[1], FIREWARAN_DROPLIST_2[2]);
					----------------------------------------------------------------------------------------------------
				...
				elseif Player[id].huntlevel == 3 then
					...
					DROP_POINT[cell].vob = Vob.Create(HUNT_FIREWARAN_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_FIREWARAN_PARAMS[2], DROP_POINT[cell].pos[3]);
					Vob.SetCollision(DROP_POINT[cell].vob, 0)
					CreateItem(FIREWARAN_DROPLIST_3[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
					GameTextForPlayer(id, 50, 6000, "Вы разделали тушу ящера","Font_Old_10_White_Hi.TGA", 218,165,32, 3000);
					SavePlayer(id);
					LogHunt(id, "FIREWARAN", true, 0, FIREWARAN_DROPLIST_3[1]);
