...
function SetCraftEXP_SKILL(instance, skill)
	instance = string.upper(instance);
	InitItem(instance);
	table.insert(CraftItem[instance].exp_skill, tostring(instance));
end
...
--АААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААаа
	...
	SetCraftEXP("OOLTYB_ITMI_CHIP", 10)
	SetCraftEXP_SKILL("OOLTYB_ITMI_CHIP", "Бронник")
	SetCraftEXP("OOLTYB_ITMI_CHIP", 10)
	SetCraftEXP_SKILL("OOLTYB_ITMI_CHIP", "Оружейник")
...
-- ААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААААА
	...
	SetCraftEXP("YFAUUN_GRD_ARMOR_H3", 150)
	SetCraftEXP_SKILL("YFAUUN_GRD_ARMOR_H3", "Бронник")	
	...
	SetCraftEXP("YFAUUN_ITAR_OLDCAMPG_L", 150)
	SetCraftEXP_SKILL("YFAUUN_ITAR_OLDCAMPG_L", "Бронник")	
...
CRAFT_POVAR_LEVELS = {1000, 3500};
CRAFT_PLOTNIK_LEVELS = {1250, 3500};
CRAFT_BRONNIK_LEVELS = {1250, 3500};
CRAFT_ORYJEYNIK_LEVELS = {1250, 3500};
CRAFT_PORTNOY_LEVELS = {1250, 3500};
CRAFT_ALHIMIC_LEVELS = {1000, 3500};
CRAFT_KOZHEVNIK_LEVELS = {1250, 3500};
...
function _craftGiveEXP(id, skill, exp)
	...
	if skill == "Повар" then
			...
			if Player[id].scraft_povar[1] > 0 then
	...
	elseif skill == "Плотник" then
		...
		if Player[id].scraft_plotnik[1] > 0 then
	...
	elseif skill == "Портной" then
		...
		if Player[id].scraft_portnoy[1] > 0 then
	...
	elseif skill == "Оружейник" then
		if Player[id].scraft_oryjeynik[1] > 0 then
	...
	elseif skill == "Бронник" then
		if Player[id].scraft_bronnik[1] > 0 then
	...
	elseif skill == "Кожевник" then
		if Player[id].scraft_kozhevnik[1] > 0 then
	...
	elseif skill == "Кузнец" then
		if Player[id].scraft_kyznec[1] > 0 then
	...
	elseif skill == "Алхимик" then
		if Player[id].scraft_alhimic[1] > 0 then
